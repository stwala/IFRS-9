...
input_excel_path1 <- args[1]  # First Excel file path
input_excel_path2 <- args[2]  # Second Excel file path

# Use these variables in your read_excel calls:
df <- read_excel(input_excel_path1)
...
# Replace 'your_file.xlsx' with your actual file path
df12 <- read_excel(input_excel_path2)
