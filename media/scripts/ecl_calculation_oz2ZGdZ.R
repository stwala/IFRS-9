...
config <- list(
  ...
  output_files = list(
    initial_results = file.path(base_dir, "media", "outputs", "1.1Updated_dataset_after_12_months.xlsx"),
    stage_results = file.path(base_dir, "media", "outputs", "1.22Updated_dataset_after_12_months.xlsx"),
    ecl_results = file.path(base_dir, "media", "outputs", "updated_dataset_with_stage_ECL.xlsx"),
    summary_results = file.path(base_dir, "media", "outputs", "summaryECL.xlsx"),
    report_results = file.path(base_dir, "media", "outputs", "IFRS9_ECL_Report_Combined.xlsx"),
    survival_results = file.path(base_dir, "media", "outputs", "Survival_ECL_Output.xlsx"),
    visualization_dir = file.path(base_dir, "media", "outputs", "visualizations")
  ),
  # Model parameters
  LGD = 0.45,
